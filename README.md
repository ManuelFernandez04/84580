...
**Curso de Introducción al desarrollo web con HTML y CSS en Educación IT. 84580, Abril/Mayo 2026**<br><br>
...
## Generadores de tablas y CSS
- [CSS Generator](https://cssgenerator.dev/) – Generador de **CSS** con interfaz visual
- [Tablas](https://www.tablesgenerator.com/html_tables) – Generador de **tablas** para HTML<br><br>


## Imágenes y video
- [Unsplash](https://unsplash.com/es) – Banco de **imágenes** gratuito
- [Pexels](https://www.pexels.com/es-es/) – Banco de **videos** gratuito